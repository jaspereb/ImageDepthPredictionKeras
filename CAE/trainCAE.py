from CAEModel import buildModelCAE
...
from dataListersCAE import buildRedwoodList
from dataGeneratorsCAE import RedwoodDataGenerator
import numpy as np
import pickle
...
checkpointer = ModelCheckpoint(filepath='/mnt/0FEF1F423FF4C54B/TrainedModels/CAE/weights.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=False)
