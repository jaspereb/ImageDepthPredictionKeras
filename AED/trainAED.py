from AEDModel import buildModelAED
...
from dataListersAED import buildRedwoodList
from dataGeneratorsAED import RedwoodDataGenerator
import numpy as np
import pickle
...
model = buildModelAED()
model.load_weights('/mnt/0FEF1F423FF4C54B/TrainedModels/CAE/weights.15-0.01.hdf5', by_name=True)
...
checkpointer = ModelCheckpoint(filepath='/mnt/0FEF1F423FF4C54B/TrainedModels/AED/weights.{epoch:02d}-{val_loss:.2f}.hdf5', verbose=1, save_best_only=False)
